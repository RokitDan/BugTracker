...
namespace BugTracker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InviteDate,JoinDate,CompanyToken,Message,IsValid,InviteeEmail,InviteeFirstName,InviteeLastName,CompanyId,ProjectId,InvitorId,InviteeId")] Invite invite)
        {
